...
public class AboutUs extends JFrame{
	...
	private JPanel contentPane;
         ...
         AboutUs() {
            ...
            JLabel l4 = new JLabel("Admission System");
            ...
            JLabel l6 = new JLabel("Developed By : Austin,Sooraj&Ajay");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Roll Number - 21,56,05");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);

            JLabel l8 = new JLabel("Contact : asa@gmail.com");
