...
class AddStudent implements ActionListener{ //did not do jframe
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String l = (String)c1.getSelectedItem();//to get the selected combo option
        ...
        if(ae.getSource() == b){
            try{
                ...
                JOptionPane.showMessageDialog(null,"Student Details Inserted Successfully");//throws popup
                f.setVisible(false);
            }catch(Exception ee){
