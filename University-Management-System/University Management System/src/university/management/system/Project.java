...
public class Project extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        String msg = ae.getActionCommand();  //string form of menu item pressed
        if(msg.equals("New Student Admission")){
            ...
            try{
                Runtime.getRuntime().exec("notepad.exe");//runtime class notepad will open
            }catch(Exception e){ }
    ...
    public static void main(String[] args){
        new Project().setVisible(true);//to see the main frame
    }
